...
def articles():
    ...
    #Retrieve geo from the html request.
    geo = request.args.get('geo')

    #If argument is missing the raise
    if not geo:
    ...
    #Return 5 articles from articles JSON
    if len(articles) > 5:
